    ...
    await queryInterface.bulkInsert('hobbies', [
      {
        ...
        finished: false,
        club_id: 1,
        created_at: Sequelize.literal('TIMESTAMP("2017-07-23",  "13:10:11")'),
        updated_at: Sequelize.literal('TIMESTAMP("2017-07-23",  "13:10:11")'),
      },
      {
        name: 'O Hobbit',
        type: 'book',
        ...
        finished: true,
        club_id: 1,
        created_at: Sequelize.literal('TIMESTAMP("2017-07-20",  "13:10:11")'),
        updated_at: Sequelize.literal('TIMESTAMP("2017-07-20",  "13:10:11")'),
      },
      {
      ...
      },
      {
        ...
        finished: false,
        club_id: 3,
        created_at: Sequelize.literal('TIMESTAMP("2017-07-24",  "13:10:11")'),
        updated_at: Sequelize.literal('TIMESTAMP("2017-07-24",  "13:10:11")'),
      },
      {
